...
-- Exportování dat pro tabulku social-network.friends: ~1 rows (přibližně)
...
-- Exportování dat pro tabulku social-network.likes: ~0 rows (přibližně)
...
CREATE TABLE IF NOT EXISTS `posts` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf32 COLLATE=utf32_czech_ci;

-- Exportování dat pro tabulku social-network.posts: ~3 rows (přibližně)
...
INSERT INTO `posts` (`id`, `user_id`, `created`, `content`, `shared_by`) VALUES
	...
	(3, 1, '2018-03-25 11:16:08', 'Druhý příspěvek uživatele Jiří Pochop', NULL);
...
-- Exportování dat pro tabulku social-network.users: ~2 rows (přibližně)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `email`, `forename`, `surname`, `password`, `header_pic`, `profile_pic`) VALUES
	(1, 'jiri.pochop01@gmail.com', 'Jiří', 'Pochop', '$2y$10$fcUTO20ZeWMix2xsGuKwJONa5BVRNbYIljMUUa4GIIp', NULL, NULL),
	(2, 'admin@admin.cz', 'Ad', 'Min', '$2y$10$XD9zMRAHC9OOePBQ29TjQODCnazm0j/bNEP1hJLqI0k', NULL, NULL);
